							...
							<table>
								...
								<tbody>
									<tr>
										...
										<td><Button isDefault isSmall onClick={ () => onChange( this.insertCode( value, '{{U:FIRST_NAME}}' ) ) }>{ __( 'Insert', 'lifterlms' ) }</Button></td>
									</tr>
								</tbody>
							</table>
